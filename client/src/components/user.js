...
import { logout, toggleAccountDropdown, fetchCurrentUser } from '../actions'
...
export default connect(mapStateToProps, { toggleAccountDropdown, logout, fetchCurrentUser })(User);
